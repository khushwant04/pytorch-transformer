...
class Transformer(nn.Module):
    ...
    def __init__(self, encoder: Encoder, decoder: Decoder, src_embed: InputEmbedding, tgt_embed: InputEmbedding, src_pos: PostitionalEncoding, tgt_pos: PostitionalEncoding, projection_layer: ProjectionLayer):
        super().__init__()
